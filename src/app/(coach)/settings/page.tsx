...
const TOGGLE_ON = { background: "#F5C518", border: "none", borderRadius: 999, width: 44, height: 24, cursor: "pointer", position: "relative" as const, transition: "background 0.2s", flexShrink: 0 };
    ...
    <div className="max-w-2xl mx-auto pb-16" dir="rtl">
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={save} disabled={saving}
          style={{ background: "#F5C518", color: "#111", border: "none", borderRadius: 999, padding: "10px 24px", fontWeight: 800, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
      ...
      <div className={SECTION}>
        <div className="flex items-center gap-2 mb-4">
          <User className="w-4 h-4" style={{ color: "#F5C518" }} />
      ...
      <div className={SECTION}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <Eye className="w-4 h-4" style={{ color: "#F5C518" }} />
          ...
          <button onClick={() => setShowPassFields(!showPassFields)} type="button"
            style={{ color: "#F5C518", fontSize: 13, background: "none", border: "none", cursor: "pointer" }}>
