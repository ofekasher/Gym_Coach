...
export default function GoalPage() {
  ...
  return (
    <div style={{ background: "#0a1a0a", minHeight: "100vh" }} className="pb-20" dir="rtl">
      ...
      <div className="max-w-sm mx-auto">
          ...
          {GOAL_TYPES.map((g) => {
            ...
            return (
              <button
                ...
                className={
                  selected
                    ? "bg-[#0f1f0f] border-2 border-[#a8ff3e] rounded-2xl p-4 flex flex-col items-center gap-2"
                    : "bg-[#0f1f0f] border border-white/10 rounded-2xl p-4 flex flex-col items-center gap-2"
                }
              >
        ...
        <div className="bg-[#0f1f0f] rounded-2xl mx-4 mt-6 p-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="bg-[#0a1a0a] border border-white/10 rounded-xl px-3 py-2 text-white w-full"
                />
          ...
          <input
            ...
            className="bg-[#0a1a0a] border border-white/10 rounded-xl px-4 py-3 text-white w-full"
          />
        ...
        <div className="bg-[#0f1f0f] rounded-2xl mx-4 mt-4 p-4">
        ...
        <div className="bg-[#0f1f0f] rounded-2xl mx-4 mt-4 p-4 mb-4">
          ...
          <textarea
            ...
            className="bg-[#0a1a0a] border border-white/10 rounded-xl p-4 text-white w-full h-24 resize-none"
          />
