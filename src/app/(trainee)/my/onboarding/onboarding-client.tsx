...
export function OnboardingClient() {
  ...
  const C = { background: "#1A1A1F", borderRadius: 20, border: "1px solid rgba(255,255,255,0.06)" };
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 28 }}>
              {[
                ...
                <div key={label} style={{ display: "flex", justifyContent: "space-between", padding: "10px 16px", background: "#1A1A1F", borderRadius: 12 }}>
