...
// Real asset: public/images/lior-onboarding.png (the user's actual Studio Lior Ziv gym photo,
// supplied directly via the design handoff zip after the Claude Design 256KB read cap
...
export default function WelcomePage() {
  return (
    <div dir="rtl" style={{ position: "relative", minHeight: "100vh", background: "#0a1a0a", color: "#fff", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      <div style={{ position: "relative", flex: "0 0 58vh", overflow: "hidden" }}>
        <img
          src="/images/lior-onboarding.png"
          alt=""
          style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 30%" }}
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, #0a1a0a 0%, rgba(10,26,10,0) 30%)" }} />
      </div>

      <div style={{ flex: 1, padding: "0 26px 46px", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
        ...
        <Link href="/login" style={{ textDecoration: "none" }}>
          <div style={{ marginTop: 30, display: "flex", alignItems: "center", background: GRADIENT, borderRadius: 999, padding: 7, height: 64 }}>
            <span style={{ flex: 1, textAlign: "center", color: "#0a1004", fontSize: 17, fontWeight: 800, paddingRight: 14 }}>החליקו כדי להתחיל</span>
