...
const isConfigured = !!GEMINI_KEY && !GEMINI_KEY.includes("your-");
...
כללים:
1. תמיד ענה בעברית
2. היה קצר וממוקד — תשובות לא ארוכות מדי
...
const DEMO_RESPONSES: Record<string, string> = {
  ...
  default: "💪 שאלה מצוינת! אני כאן לעזור עם כל שאלה על כושר ותזונה.",
};
